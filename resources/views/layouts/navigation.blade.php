        ...
        <div class="pt-8 pb-2 border-b border-smartfit-border-light flex-grow">
            ...
            <nav>
                <ul class="flex flex-col gap-2">
                    ...
                    <li><x-sf-nav-link :href="route('training')" :active="request()->routeIs('training-edit')" :icon="asset('images/I123_11372_104_3593_67_3627_35_197.svg')">{{ __('トレーニング記録') }}</x-sf-nav-link></li>
